...
- **Download the pre-built zip** — grab the latest release from the [Releases page](https://github.com/RubenAayush2002/ZeroDrift-ChromeExtension/releases), no build tooling needed.
